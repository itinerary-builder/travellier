...
restaurants.each_with_index do |resto, index|
    ...
    restaurant.photo.attach(io: processed, filename: "#{resto[:name].downcase}.jpg", content_type: 'image/jpg')
    restaurant.save
...
place_1.photo.attach(io: processed, filename: "#{place["results"][0]["name"]}.jpg", content_type: 'image/jpg')
place_1.save
puts "Finish place 1..."
