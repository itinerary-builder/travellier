...
array_from_yelp_porto["businesses"].each do |resto|
    restaurants << {
        name: resto["name"],
        category: "Restaurants",
        lat: resto["coordinates"]["latitude"],
...
# Array of restaurants for NAZARE #

array_from_yelp_nazare = search('nazare')

array_from_yelp_nazare["businesses"].each do |resto|
    restaurants << {
        name: resto["name"],
        category: "Restaurants",
        lat: resto["coordinates"]["latitude"],
...
array_from_yelp_evora["businesses"].each do |resto|
    restaurants << {
        name: resto["name"],
        category: "Restaurants",
        lat: resto["coordinates"]["latitude"],
